...
from text_to_sql.nodes import classify_query_intent
from evals.intent_dataset import INTENT_BENCHMARK_CASES, IntentTestCase
...
def save_intent_report_to_json(
    summary: IntentEvalSummary, filepath: str = "reports/eval_intent_report.json"
):
